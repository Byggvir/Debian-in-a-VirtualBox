...
Die Rolle VirtualGuestAdditions führt Tasks aus, die wie folgt gruppiert sind:
...
Die Rolle VirtualGuestAdditions nutzt folgende Variablen in *defaults* und / oder *vars*:

Die Rolle VirtualGuestAdditions nutzt folgende Variablen in vars:
...
Die Rolle VirtualGuestAdditions nutzt folgende Templates in *templates*:
...
Die Rolle VirtualGuestAdditions nutzt folgende Dateien in *files*:
...
Die Rolle VirtualGuestAdditions nutzt folgende Meta-Daten:
